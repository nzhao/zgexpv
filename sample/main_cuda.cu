...
//======================================================================
  ...
  // expokit in FORTRAN;
  main_cuda_( &nspin, &nTerm, coeff_lst, nbody_lst, pos_i_idx, pos_i_lst, dim_i_lst, mat_i_idx, mat_i_lst, &ham_dim, nspin_dim, v, &pos_idx, &mat_idx, &klim, &maxThreadsPerBlock, maxGridSize, &tn, ta, &m, &tol, &itrace, w_seq, &w_seq_len );
